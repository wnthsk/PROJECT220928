...
interface MP3Interface2 { // 인터페이스 선언
    public void play();
    public void stop();
}
class PDA2 { // 클래스 작성
...
// MobilePhoneInterface와 MP3Interface 인터페이스에 선언된 주소상 메소드를 모두 구현한다.
class SmartPhone2 extends PDA2 implements
        MobilePhoneInterface, MP3Interface2 {
